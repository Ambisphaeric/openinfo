...
import { Health, JsonSchema, CaptureSource, CaptureChunk, Ack, QueueStatus, RelevantEntity, StartSessionRequest } from './api/payloads.js'
...
export const AllSchemas = {
  ...
  Health, JsonSchema, CaptureSource, CaptureChunk, Ack, QueueStatus, RelevantEntity, StartSessionRequest,
} as const
