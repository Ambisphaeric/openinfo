...
export const BlockTypeName = Type.Union(
  ['now', 'moments', 'relevant-now', 'ledger', 'pinned-doc', 'hint', 'ask', 'todos', 'drafts', 'teach', 'distillates', 'fields', 'queue', 'transcript-inspector', 'sense-gates', 'custom'].map((b) => Type.Literal(b)),
  { $id: 'BlockTypeName' },
)
