...
2. Pick the **topmost unblocked item** (skip anything marked owner-required unless the owner
   is present in this session). State the pick and its slice plan in 2–3 lines; if the owner
