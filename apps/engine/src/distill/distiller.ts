...
import type { CaptureChunk, Distillate, Mode, PromptTemplate, VoiceBinding } from '@openinfo/contracts'
...
export class Distiller {
  ...
  async distillChunks(chunks: readonly CaptureChunk[]): Promise<Distillate[]> {
