...
│  ├─ src/config/               P0   surface(block/action), mode, voice, fabric, flag · workflow (P4A: WorkflowSpec — ordered flag-gated steps document; the pipeline as a cloneable doc) · todo (P4A-s4: TodoList/TodoItem — the editable session to-do document the constrain/unconstrain loop accumulates into)
